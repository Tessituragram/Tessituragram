    ...
    with open(CSV_FILE, "w", newline="", encoding="utf-8") as f:
        ...
        for _, filename, tab in zip(arias, midi_filenames, tabs):
            ...
            try:
                ...
                add_result("time_dose", tess[0].time_dose, float(measurement_values[2]))  
                add_result("rest_time", tess[0].rest_time, float(measurement_values[3]))
                add_result("min_freq", tess[0].min_pitch, float(measurement_values[4]))    
                ...
                add_result("max_freq", tess[0].max_pitch, float(measurement_values[8]))
                # Passaggio values
                p = passaggio[0]
