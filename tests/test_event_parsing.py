...
def test_sequence_number_1():
    ...
    test_path = os.path.join(
        "data", "test_event_parsing", "sequence_number_event_1.mid"
    )
...
def test_sequence_number_2():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "sequence_number_event_2.mid"
    )
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_text_event():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "text_event.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_track_name():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "track_name.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_instrument_name():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "instrument_name.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_lyric_text():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "lyric_text.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_marker_text():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "marker_text.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_cue_point():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "cue_point.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_midi_channel_prefix_assignment():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "channel_prefix_assignment.mid"
    )
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_end_of_track():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "end_of_track.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert event == None
...
def test_tempo_change():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "tempo_change.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
...
def test_midi_port():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "midi_port.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
...
def test_smpte_offset():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "smpte_offset.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_invalid_event():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "invalid_event.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert event == -1
...
def test_time_signature():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "time_signature.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_key_signature():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "key_signature.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_key_signature_2():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "key_signature_2.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
    assert event.event_name == "Key Signature"
...
def test_sequencer_specific_event():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "sequencer_specific_event.mid"
    )
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_unknown_meta_event():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "unknown_meta_event_4b.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
    assert isinstance(event, MetaEvent)
...
def test_note_aftertouch_running_status():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "note_aftertouch_running_status.mid"
    )
    reader = midi_reader.MidiParser(test_path)
...
def test_note_off_running_status():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "note_off_event_running_status.mid"
    )
    reader = midi_reader.MidiParser(test_path)
    events = reader.parse_midi_event()
    assert len(events) == 3
...
def test_note_on_running_status():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "note_on_event_running_status.mid"
    )
    reader = midi_reader.MidiParser(test_path)
    events = reader.parse_midi_event()
    assert len(events) == 3
...
def test_controller_event_running_status():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "controller_event_running_status.mid"
    )
    reader = midi_reader.MidiParser(test_path)
    events = reader.parse_midi_event()
    assert len(events) == 3
...
def test_program_change_event_running_status():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "program_change_event_running_status.mid"
    )
    reader = midi_reader.MidiParser(test_path)
    events = reader.parse_midi_event()
    assert len(events) == 3
...
def test_channel_aftertouch_event_running_status():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "channel_aftertouch_event_running_status.mid"
    )
    reader = midi_reader.MidiParser(test_path)
    events = reader.parse_midi_event()
    assert len(events) == 3
...
def test_pitch_bend_event_running_status():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "pitch_bend_event_running_status.mid"
    )
    reader = midi_reader.MidiParser(test_path)
    events = reader.parse_midi_event()
    assert len(events) == 3
...
def test_system_exclusive_event():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "system_exclusive_event.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
...
def test_system_messages():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "system_messages.mid")
    reader = midi_reader.MidiParser(test_path)
    event = reader.parse_midi_event()
...
def test_parse_track_invalid_event():
    ...
    """
    test_path = os.path.join(
        "data", "test_event_parsing", "parse_track_invalid_event.mid"
    )
    reader = midi_reader.MidiParser(test_path)
...
def test_invalid_track_length():
    ...
    """
    test_path = os.path.join("data", "test_event_parsing", "invalid_track_length.mid")
    reader = midi_reader.MidiParser(test_path)
    out = reader.parse_track()
    assert out == -1
