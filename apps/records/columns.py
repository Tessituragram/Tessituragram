...
AVAILABLE_COLUMNS = [
    ...
    ("full_range", "Full Range (Hz)", "min_freq", lambda r: f"{r.min_freq}–{r.max_freq}"),
    ...
    ("hvhp_time_dose", "HV High Passaggio", "hvhp_time_dose", lambda r: r.hvhp_time_dose),
    ("hvmp_time_dose", "HV Middle Passaggio", "hvmp_time_dose", lambda r: r.hvmp_time_dose),
    ("hvlp_time_dose", "HV Low Passaggio", "hvlp_time_dose", lambda r: r.hvlp_time_dose),
    ("mvhp_time_dose", "MV High Passaggio", "mvhp_time_dose", lambda r: r.mvhp_time_dose),
    ("mvmp_time_dose", "MV Middle Passaggio", "mvmp_time_dose", lambda r: r.mvmp_time_dose),
    ("mvlp_time_dose", "MV Low Passaggio", "mvlp_time_dose", lambda r: r.mvlp_time_dose),
    ("lvhp_time_dose", "LV High Passaggio", "lvhp_time_dose", lambda r: r.lvhp_time_dose),
    ("lvmp_time_dose", "LV Middle Passaggio", "lvmp_time_dose", lambda r: r.lvmp_time_dose),
    ("lvlp_time_dose", "LV Low Passaggio", "lvlp_time_dose", lambda r: r.lvlp_time_dose),
    ("status", "Status", "status", lambda r: r.get_status_display())
]

DEFAULT_TABLE_COLUMNS = ["composer", "author", "style", "clef_range", "tessitura_range"]
DEFAULT_PROFILE_COLUMNS = ["composer", "author", "style", "clef_range", "tessitura_range", "status"]
DEFAULT_REVIEW_COLUMNS = ["composer", "author", "style", "clef_range", "submitter", "created_at"]

COLUMN_MAP = {key: (label, sort_field, accessor) for key, label, sort_field, accessor in AVAILABLE_COLUMNS}
